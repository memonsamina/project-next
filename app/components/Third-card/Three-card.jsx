        ...
        {cardData.map((item) => (
          <div class="col f-2">
            <div class="card back-shadow">
              ...
              <Image class="name" className="rounded" width={335} src={item.imgUrl} alt="logo" />
              <div class="card-body">
                <div className="d-flex justify-content-between">
                  <p>{item.heading}</p>
              ...
              <div className="mx-5 ">
   <button class="btn btn-cOlorr text-white rounded-pill mx-5 py-2 px-5" type="submit">{item.buttoN}</button>
